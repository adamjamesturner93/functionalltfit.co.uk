...
export default function YogaVideoFormClient({ initialYogaVideo, id }: YogaVideoFormClientProps) {
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Controller
                      ...
                      control={control}
                      render={({ field }) => (
                        <Textarea id="description" className="min-h-[120px]" {...field} />
                      )}
                    />
                    {errors.description && (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    />
                    {errors.thumbnailUrl && (
                      <p className="mt-1 text-sm text-destructive">{errors.thumbnailUrl.message}</p>
                    )}
                  </div>
          ...
          <Card className="mt-8">
            ...
            <CardContent>
              <div className="mb-4">
                <Select
                  value={timeFrame}
                  onValueChange={(value: 'week' | 'month' | '6months') => setTimeFrame(value)}
                >
                  <SelectTrigger>
