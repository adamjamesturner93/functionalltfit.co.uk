...
import { Apple, Heart, Activity, Smartphone, Clock, Check } from "lucide-react";
...
export default function FitnessAppLanding() {
  return (
    <>
      <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-b from-secondary/20 to-background">
        <div className="container px-4 md:px-6">
          <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
            <div className="flex flex-col justify-center space-y-4">
              <div className="space-y-2">
                <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                  Fitness for Every Body, Every Schedule
                </h1>
            ...
            <Image
              alt="FunctionallyFit App Interface showing adaptive workouts"
            ...
            {[
              {
                ...
                features: [
                  "Ad-supported",
                  "Progress tracking",
                  "Programmes capped at 2 weeks (including workouts and yoga)",
              ...
              },
              {
                ...
                features: [
                  ...
                  "Access to on-demand yoga and mindfulness classes",
                  "Unlimited premium pre-made programmes",
            ...
            <Card>
              <CardContent className="p-6">
                <p className="text-muted-foreground mb-4">
                  As someone with chronic pain, FunctionallyFit has been a
                  game-changer. The adaptive workouts have helped me stay active
                  without aggravating my condition.
                </p>
                <p className="font-semibold">
                  - Sarah J., Living with Fibromyalgia
                </p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                <p className="text-muted-foreground mb-4">
                  Being a single dad, finding time for fitness was impossible.
                  FunctionallyFit&apos;s quick workouts fit perfectly into my
                  hectic schedule.
                </p>
                <p className="font-semibold">- Michael R., Single Parent</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="p-6">
                <p className="text-muted-foreground mb-4">
                  The personalised programmes have helped me manage my diabetes
                  better. I feel stronger and more in control of my health.
                </p>
                <p className="font-semibold">
                  - Emma L., Managing Type 2 Diabetes
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container px-4 md:px-6">
          ...
          >
            <AccordionItem value="item-1">
              <AccordionTrigger>
                Is FunctionallyFit suitable for people with limited mobility?
              </AccordionTrigger>
              <AccordionContent>
                FunctionallyFit offers a range of adaptive workouts designed
                specifically for people with limited mobility or disabilities.
                Our expert trainers create routines that can be modified to suit
                your individual needs and abilities.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2">
              <AccordionTrigger>
                How can FunctionallyFit help busy parents stay fit?
              </AccordionTrigger>
              <AccordionContent>
                FunctionallyFit understands the time constraints of busy
                parents. We offer quick, effective workouts that can be done in
                as little as 10 minutes. Plus, our app provides flexible
                scheduling to help you fit exercise into your day, no matter how
                hectic it gets.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
              <AccordionTrigger>
                Can FunctionallyFit help with managing long-term health
                conditions?
              </AccordionTrigger>
              <AccordionContent>
                Yes, FunctionallyFit offers specialised programmes for various
                long-term health conditions. Our workouts are designed in
                consultation with health professionals to ensure they&apos;re
                safe and beneficial for managing conditions like diabetes,
                arthritis, and heart disease. Always consult your doctor before
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                Download FunctionallyFit now and take the first step towards a
                healthier, more balanced you - no matter your schedule or
                ability.
              </p>
            </div>
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
