...
export default async function Dashboard() {
  ...
  if (startDate && userProgramme) {
    ...
    nextSession =
      thisWeeksSessions.find((activity) => !activity.completed) || null;
  }
                ...
                {thisWeeksSessions.map((activity) => (
                  ...
                  >
                    <Link
                      ...
                      className="flex items-center space-x-2 hover:underline flex-1"
                    >
                      {activity.activityType === "WORKOUT" ? (
              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Quickly log your body measurements
                    </DialogDescription>
                  </DialogHeader>
                  <QuickAddForm />
                </DialogContent>
